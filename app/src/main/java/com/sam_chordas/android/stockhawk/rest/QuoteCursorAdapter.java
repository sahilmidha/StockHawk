...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
  ...
  public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor){
    ...
    //Accessibility
    viewHolder.symbol.setContentDescription(mContext.getString(R.string.symbol) + symbol + mContext.getString(R.string.symbol_name) + name);
    viewHolder.bidPrice.setContentDescription(mContext.getString(R.string.bid_price) + bidPrice);
    if(Utils.showPercent)
    {
      viewHolder.change.setContentDescription(mContext.getString(R.string.change) + percentChange);
    }else {
